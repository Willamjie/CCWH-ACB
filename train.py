...
def train(hyp, tb_writer, opt, device):
    ...
    ########scheduler = lr_scheduler.CosineAnnealingLR(optimizer, 12, eta_min=0.0001, last_epoch=-1)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if (epoch+1) % checkpoint_interval == 0:
                ...
                path_checkpoint="./weights/SWA_BASE_OPEN/checkpoint_{}_epoch.pt".format(epoch)
                torch.save(ckpt, path_checkpoint)
